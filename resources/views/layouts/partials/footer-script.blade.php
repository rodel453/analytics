<a class="scroll-to-top rounded" href="#page-top">
    ...
    <script src="{{ asset('startbootstrap/js/demo/chart-bar-demo.js') }}"></script>
    <script src="{{ asset('/startbootstrap/js/demo/groundtruth-chart.js') }}"></script>

    <script src="{{ asset('/startbootstrap/jscrop/ijaboCroptool/ijaboCropTool.min.js') }}"></script>
