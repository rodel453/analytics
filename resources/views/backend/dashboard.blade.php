...
<h3 class="text-themecolor">Backend Dashboard</h3>
...
<div class="row">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <div class="col-xl-3 col-md-6 mb-4">
        <a style="text-decoration:none;" href="/admin/website">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Website Count</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $websitecount }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <!-- Earnings (Monthly) Card Example -->
    <div class="col-xl-3 col-md-6 mb-4">
        <a style="text-decoration:none;" href="/admin/new-users">
