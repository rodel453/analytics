...
<div class="col-xl-8 col-lg-7">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="mb-2 d-flex justify-content-between">
                <h6 class="m-0 ml-3 font-weight-bold text-gray-800">India</h6>
                <h6 class="m-0 mr-3 font-weight-bold text-gray-800">4</h6>
            </div>
            <div class="mb-2 d-flex justify-content-between">
                <h6 class="m-0 ml-3 font-weight-bold text-gray-800">Indonesia</h6>
                <h6 class="m-0 mr-3 font-weight-bold text-gray-800">3</h6>
            </div>
            <div class="mb-2 d-flex justify-content-between">
                <h6 class="m-0 ml-3 font-weight-bold text-gray-800">Brazil</h6>
                <h6 class="m-0 mr-3 font-weight-bold text-gray-800">2</h6>
            </div>
            <div class="mb-2 d-flex justify-content-between">
                <h6 class="m-0 ml-3 font-weight-bold text-gray-800">Australia</h6>
                <h6 class="m-0 mr-3 font-weight-bold text-gray-800">2</h6>
            </div>
            <div class="d-flex justify-content-between">
                <h6 class="m-0 ml-3 font-weight-bold text-gray-800">Malaysia</h6>
                <h6 class="m-0 mr-3 font-weight-bold text-gray-800">1</h6>
            </div>
