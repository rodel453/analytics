...
<div class="container-fluid">
    ...
    <input type="hidden" id="custId" name="custId" value=<?php echo($campaign_id) ?> >

                    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h3 class="text-themecolor ">Campaign</h3>
...
$(function() {
        ...
        $('input[name="daterange"]').daterangepicker({
            ...
            let campaign_id = document.getElementById("custId").value;
        ...
        processing: true,
        serverSide: true,
        ajax: '/get/account/table-account-campaign/'+campaign_id+'?start_date='+start_date+'&end_date='+end_date+'',
        columns: [
